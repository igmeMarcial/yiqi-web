export const translations: Record<string, { [key: string]: string }> = {
  en: {
    ...
    addFirstFieldButton: 'Agregar primer campo',
    startCreatingFormHeader: 'Comienza a crear tu formulario',
    buildPerfectFormText:
      'Crea tu formulario perfecto añadiendo campos personalizados y preguntas',
    fieldSettings: 'Configuración del campo',
    configureFieldText: 'Configura las propiedades del campo seleccionado',
    required: 'Requerido',
    placeholder: 'Introduce tu texto...',
    helpText: 'Texto de ayuda',
    longTextSettings: 'Configuración de texto largo',
    summary: 'Resumen',
    validationSettings: 'Configuración de validación',
    enableValidation: 'Habilitar validación',
    choiceSettings: 'Configuración de opciones',
    ...
    maxFileSizeField: 'Tamaño máximo del archivo (MB)',
    allowedFileTypes: 'Tipos de archivo permitidos',
    configureYourField: 'Configura tu campo',
    selectFieldText:
      'Selecciona un campo de tu formulario para personalizar sus configuraciones y propiedades',
    images: 'Imágenes',
    pdf: 'PDF',
    wordDocuments: 'Documentos de Word',
    allFiles: 'Todos los archivos',
    enterPlaceholderText: 'Ingresa el texto',
    formElements: 'Elementos del formulario',
    formHeader: 'Mi espacio de trabajo',
    publish: 'Publicar',
    publishSuccessTitle: 'Formulario Publicado',
    publishSuccessDescription:
      'El formulario "{formName}" se ha publicado exitosamente.',
    publishErrorTitle: 'Falló la publicación',
    publishErrorDescription: 'No se pudo publicar el formulario',
    formErrorTitle: 'Error',
    formErrorDescription:
      'El formulario debe tener al menos un campo antes de publicarlo.',
    newFormName: 'Mi nuevo formulario',
    newFormDescription: 'Este es mi nuevo formulario',
    editFormDetails: 'Editar detalles del formulario',
    formName: 'Nombre del formulario',
    descriptionModal: 'Descripción',
    formNameError: 'El nombre del formulario no puede estar vacío',
    cancelModal: 'Cancelar',
    saveChangesModal: 'Guardar cambios',
    publishSuccessTitleText: '¡Tu formulario ha sido publicado!',
    copyLink: 'Copiar enlace',
    copied: '¡Copiado!',
    copyFailed: 'Error al copiar',
    copyDescription: 'URL del formulario copiada al portapapeles',
    retryDescription: 'Por favor, inténtalo de nuevo',
    nextActionsTitle: 'Esto es lo que puedes hacer a continuación:',
    setUpIntegrations: 'Configurar integraciones y notificaciones',
    shareForm: 'Compartir o incrustar tu formulario',
    addElementsTitle: 'Agregar elementos al formulario',
    searchPlaceholder: 'Buscar elementos..',
    noElementsFound: 'No se encontraron elementos.',
    contactInfoGroup: 'Información de contacto',
    textGroup: 'Texto',
    textAndVideoGroup: 'Texto y Video',
    choiceGroup: 'Opción',
    ratingAndRankingGroup: 'Clasificación y evaluación',
    dragToReorder: 'Arrastra para reordenar',
    fieldSettingsElement: 'Configuración del campo',
