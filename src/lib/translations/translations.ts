export const translations: Record<string, { [key: string]: string }> = {
  en: {
    ...
    formEmptyErrorDescription: "The form must have at least one field before publishing.",
     publish:'Publish',
  },
  es: {
    // General
    ...
    publishErrorDescription: "No se pudo publicar el formulario. Inténtalo nuevamente.",
    formErrorTitle: "Error inesperado",
    formErrorDescription: "Ocurrió un error al intentar publicar el formulario.",
     formEmptyErrorTitle: "Error",
    formEmptyErrorDescription: "El formulario debe tener al menos un campo antes de publicarlo.",
    publish:'Publicar',
  }
}
