export const translations: Record<string, { [key: string]: string }> = {
  en: {
    ...
    startCreatingFormHeader: 'Start Creating Your Form',
    buildPerfectFormText:
      'Build your perfect form by adding custom fields and questions',
    fieldSettings: 'Field Settings',
    configureFieldText: 'Configure the selected fields properties',
    required: 'Required',
    placeholder: 'Placeholder',
    helpText: 'Help Text',
    longTextSettings: 'Long Text Settings',
    summary: 'Summary',
    ...
    maxFileSizeField: 'Max File Size (MB)',
    allowedFileTypes: 'Allowed File Types',
    configureYourField: 'Configure Your Field',
    selectFieldText:
      'Select a field from your form to customize its settings and properties',
    images: 'Images',
    pdf: 'PDF',
    ...
    formHeader: 'My workspace',
    publish: 'Publish',
    publishSuccessTitle: 'Form Published',
    publishSuccessDescription:
      'Form "{formName}" has been successfully published.',
    publishErrorTitle: 'Publish Failed',
    publishErrorDescription: 'Unable to publish form',
    formErrorTitle: 'Error',
    formErrorDescription:
      'The form must have at least one field before publishing.',
    newFormName: 'My new form',
    newFormDescription: 'This is my new form',
    editFormDetails: 'Edit Form Details',
    formName: 'Form Name',
    descriptionModal: 'Description',
    formNameError: 'Form name cannot be empty',
    cancelModal: 'Cancel',
    saveChangesModal: 'Save changes',
    publishSuccessTitleText: 'Your form has been published!',
    copyLink: 'Copy link',
    copied: 'Copied!',
    copyFailed: 'Failed to copy',
    copyDescription: 'Form URL copied to clipboard',
    retryDescription: 'Please try again',
    nextActionsTitle: 'Here is what you can do next:',
    setUpIntegrations: 'Set up integrations and notifications',
    shareForm: 'Share or embed your form',
    addElementsTitle: 'Add form elements',
    searchPlaceholder: 'Search form elements...',
    noElementsFound: 'No elements found.',
    contactInfoGroup: 'Contact info',
    textGroup: 'Text',
    textAndVideoGroup: 'Text & Video',
    choiceGroup: 'Choice',
    ratingAndRankingGroup: 'Rating & ranking',
    dragToReorder: 'Drag to reorder',
    fieldSettingsElement: 'Field settings',
