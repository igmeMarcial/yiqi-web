...
export default function SearchForm({ onSearch, locations }: SearchFormProps) {
  ...
  return (
    <div className="bg-black relative overflow-hidden">
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:pb-0">
        <form
        ...
        >
          ...
          <div className="flex flex-col space-y-2 pl-2 w-full sm:w-1/6">
            ...
            <div className="relative">
              <select
                className={`border-b-2 text-sm p-[0.659375rem] w-full rounded-md bg-white ${
                  !location
                    ? 'border-gray-400 text-gray-500'
                    : 'border-gray-300 focus:outline-none focus:border-blue-500'
                }`}
          ...
          <div className="flex flex-col space-y-2 pl-2 w-full sm:w-1/6">
            ...
            <div className="relative">
              <select
                className={`border-b-2 text-sm p-2 w-full rounded-md bg-white ${
                  !type
                    ? 'border-gray-400 text-gray-500'
                    : 'border-gray-300 focus:outline-none focus:border-blue-500'
                }`}
          ...
          <div className="w-full sm:w-auto mt-6 sm:mt-0 sm:pl-2 flex justify-center sm:col-span-6 pt-6">
            <Button
              type="submit"
              size="sm"
