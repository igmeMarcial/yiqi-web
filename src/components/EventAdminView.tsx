...
export function EventAdminView({ registrations, eventId }: Props) {
  ...
  return (
    <div className="container mx-auto px-4">
      <h2 className="text-xl font-bold text-secondary dark:text-gray-100">{t('eventManagement')}</h2>
      ...
      <Tabs defaultValue="attendees">
        ...
        <TabsContent value="settings">
          ...
          <p className="text-gray-700 dark:text-gray-300">{t('settingsDescription')}</p>
        </TabsContent>

        <TabsContent value="communications">
          <h2 className="text-xl font-semibold mb-2">{t('eventCommunications')}</h2>
